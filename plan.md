...
Build a private Pi 0.83.0 package with no production dependencies beyond Pi's required peers. The extension owns `/goal` and exposes `goal_subagent`, `goal_ack_output`, `goal_resolve`, `goal_review`, and `goal_done`.
